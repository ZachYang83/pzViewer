...
import { getCiv, getMed, getEdu, getPal,getHousePrice } from "@/api/pubinfo/pubInfo.js";
...
export default {
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "pz_houseprice", "circle", circle);
      window.MAP.addLayer({
        id: "pz_houseprice-hl",
        type: "circle",
        source: "pz_houseprice",
        "source-layer": "pz_houseprice",
        paint: {
          "circle-color": "#18ffff",
          "circle-radius": 8,
    ...
    getInfo(e) {
      ...
      if (features[0].layer.id == "pz_houseprice") {
        var props = features[0].properties;
        window.MAP.setFilter("pz_houseprice-hl",[
          "in",
          "id",
          features[0].properties.id
        ])
        _this.propsData = getHousePrice(props);
      }
      _this.visible = true;
