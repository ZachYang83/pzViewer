...
import { getCiv, getMed, getEdu, getPal,getSecondHouse} from "@/api/pubinfo/pubInfo.js";
...
export default {
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "pz_secondhouse", "circle", circle);
      window.MAP.addLayer({
        id: "pz_secondhouse-hl",
        type: "circle",
        source: "pz_secondhouse",
        "source-layer": "pz_secondhouse",
        paint: {
          "circle-color": "#18ffff",
          "circle-radius": 8,
    ...
    getInfo(e) {
      ...
      if (features[0].layer.id == "pz_secondhouse") {
        var props = features[0].properties;
        window.MAP.setFilter("pz_secondhouse-hl",[
          "in",
          "id",
          features[0].properties.id
        ])
        _this.propsData = getSecondHouse(props);
      }
      _this.visible = true;
