...
import {add_wms, add_tms, addgeojson_S, addgeojson_L } from "utils/loadLayer.js";
...
export default {
  ...
  methods: {
    init() {
      ...
      window.MAP.setCenter([113.351, 23.094]);
  ...
  destroyed() {
    ...
    if (window.MAP.getSource("pz_hongxian")) {
      window.MAP.removeSource("pz_hongxian");
    }
    let _this = this;
