...
import { getCiv, getMed, getEdu, getPal,getSpo } from "@/api/pubinfo/pubInfo.js";
...
export default {
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "pz_jcss_spo", "circle", circle);
      window.MAP.addLayer({
        id: "pz_jcss_spo-hl",
        type: "circle",
        source: "pz_jcss_spo",
        "source-layer": "pz_jcss_spo",
        paint: {
          "circle-color": "#18ffff",
          "circle-radius": 8,
    ...
    getInfo(e) {
      ...
      if (features[0].layer.id == "pz_jcss_spo") {
        var props = features[0].properties;
        window.MAP.setFilter("pz_jcss_spo-hl",[
          "in",
          "id",
          features[0].properties.id
        ])
        _this.propsData = getSpo(props);
      }
      _this.visible = true;
