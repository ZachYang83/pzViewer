...
import { getCiv, getMed, getEdu, getPal } from "@/api/pubinfo/pubInfo.js";
...
export default {
  ...
  methods: {
    initLayers() {
      ...
      add_tms(window.MAP, "pz_jcss_civ", "circle", circle);
      window.MAP.addLayer({
        id: "pz_jcss_civ-hl",
        type: "circle",
        source: "pz_jcss_civ",
        "source-layer": "pz_jcss_civ",
        paint: {
          "circle-color": "#18ffff",
          "circle-radius": 8,
    ...
    getInfo(e) {
      ...
      if (features[0].layer.id == "pz_jcss_civ") {
        var props = features[0].properties;
        window.MAP.setFilter("pz_jcss_civ-hl",[
          "in",
          "id",
